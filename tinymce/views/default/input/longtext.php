...
<script language="javascript" type="text/javascript">
    tinyMCE.init({
        ...
        plugins: "advlist autolink charmap code emoticons hr image insertdatetime link lists paste preview print table textcolor wordcount",
        menubar: false,
        toolbar_items_size: "small",
        toolbar1: "newdocument preview print | styleselect | fontselect | fontsizeselect",
